    ...
    genMonth: function genMonth(date, index) {
      ...
      return h(Month, {
        ...
        "on": {
          ...
          "update-height": this.onUpdateHeight
        }
      });
    },
...
/* harmony default export */ var es_image = (image_createComponent({
  ...
  methods: {
    ...
    genPlaceholder: function genPlaceholder() {
      ...
      if (this.loading && this.showLoading && utils["b" /* inBrowser */]) {
        return h("div", {
  ...
  watch: {
    ...
    currentIndex: function currentIndex() {
      ...
      if (this.stickyFixed && !this.scrollspy) {
        setRootScrollTop(Math.ceil(scroll_getElementTop(this.$el) - this.offsetTopPx));
      }
    },
